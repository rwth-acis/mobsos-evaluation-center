...
node --max_old_space_size=8000 node_modules/@angular/cli/bin/ng serve --host 0.0.0.0 --prod=true --disable-host-check  --serve-path ${SERVE_PATH} --disable-host-check --base-href=monitor